package com.bank.bian.frauddiagnosis.model;
...
/**
 * The BIAN control record for this service domain: "Fraud Case Assessment".
 *
 ...
 * to its asset type (Fraud Case). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Fraud Case Assessment";
